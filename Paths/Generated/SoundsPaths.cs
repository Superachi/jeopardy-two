...
namespace RecoilTwo.Paths.Generated;

public class SoundsPaths
{
    public const string Root = "res://Assets/Sounds/";

    // Assets/Sounds/PointGain
    public const string Sounds_PointGain_ = Root + "PointGain/";
        // Assets/Sounds/PointGain/HighValue
        public const string Sounds_PointGain_HighValue_ = Sounds_PointGain_ + "HighValue/";
            // Assets/Sounds/PointGain/HighValue/money-soundfx.mp3
            public const string Sounds_PointGain_HighValue_MoneySoundfx = Sounds_PointGain_HighValue_ + "money-soundfx.mp3";
        // Assets/Sounds/PointGain/LowValue
        public const string Sounds_PointGain_LowValue_ = Sounds_PointGain_ + "LowValue/";
            // Assets/Sounds/PointGain/LowValue/correct-answer.mp3
            public const string Sounds_PointGain_LowValue_CorrectAnswer = Sounds_PointGain_LowValue_ + "correct-answer.mp3";
            // Assets/Sounds/PointGain/LowValue/mario-coin.mp3
            public const string Sounds_PointGain_LowValue_MarioCoin = Sounds_PointGain_LowValue_ + "mario-coin.mp3";
            // Assets/Sounds/PointGain/LowValue/sonic-ring.mp3
            public const string Sounds_PointGain_LowValue_SonicRing = Sounds_PointGain_LowValue_ + "sonic-ring.mp3";
        // Assets/Sounds/PointGain/MidValue
        public const string Sounds_PointGain_MidValue_ = Sounds_PointGain_ + "MidValue/";
            // Assets/Sounds/PointGain/MidValue/botw-item.mp3
            public const string Sounds_PointGain_MidValue_BotwItem = Sounds_PointGain_MidValue_ + "botw-item.mp3";
            // Assets/Sounds/PointGain/MidValue/cha-ching-money.mp3
            public const string Sounds_PointGain_MidValue_ChaChingMoney = Sounds_PointGain_MidValue_ + "cha-ching-money.mp3";
            // Assets/Sounds/PointGain/MidValue/pokemon-black-white-sound-gamerip-item-obtained.mp3
            public const string Sounds_PointGain_MidValue_PokemonBlackWhiteSoundGameripItemObtained = Sounds_PointGain_MidValue_ + "pokemon-black-white-sound-gamerip-item-obtained.mp3";

    // Assets/Sounds/PointLoss
    public const string Sounds_PointLoss_ = Root + "PointLoss/";
        // Assets/Sounds/PointLoss/HighValue
